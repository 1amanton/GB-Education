...
Vue.component("search", {
    ...
    template:`
        <form @submit.prevent="$root.searchFilter" action="#" class="h-search">
            <input  v-model="$root.userSearch" type="text" placeholder="Search..." class="h-search-field">
...
Vue.component("carticon", {
    ...
    template:`
        <div class="h-right">          
            ...
            <span v-show="$root.countCart()" class="h-basket-counter">{{ $root.countCart() }}</span>
